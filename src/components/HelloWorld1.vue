	...
	<div class="wrapper">
		<div class="content">
          ...
          <vueCropper ref="cropper" :img="option.img" :outputSize="option.size" :outputType="option.outputType"
                    ...
                    :maxImgSize="option.maxImageSize" @realTime="realTime" @imgLoad="imgLoad" @cropMoving="cropMoving"
          ...
          <section class="pre-item" title="zoom: (100 / previews.h ,100/previews.w)">
            <p>固定为100高度</p>
...
/*.title, .title:hover, .title-focus, .title:visited {
		color: black;
	}  texst预览大图     点击btn  内容content    预览图pre pre-item */
